...
import CorporateSideBar from '@/components/SideBars/CorporateSidebar';
...
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  async function getReservation(){
    const res = await fetch(`/api/get-reservation-corporate?res=${encodeURI(resQuery!)}`,{
      next: { revalidate: 10 } 
    } )
      ...
      <button
        ...
        <div className="mb-6 flex items-center">
          <input 
            ...
            placeholder="Consultar reserva de tour" 
