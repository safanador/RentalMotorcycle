...
function Form({bike, sendDataToParent, location, pud, put, dod, dot}:DialogFormProps) {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
        ...
        <div className='flex flex-col w-full mb-2'>
            ...
            <Input onChange={formik.handleChange} name='phoneNumber' type='text' placeholder='Type here' className='input input-bordered w-full max-w-lg'/>
